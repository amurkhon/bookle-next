...
import { NEXT_PUBLIC_REACT_APP_API_URL } from '../../libs/config';
						...
						<Stack className={'property-info-config'}>
							...
							<Stack className={'images'}>
								<Stack className={'main-image'}>
									<img
										src={slideImage ? `${NEXT_PUBLIC_REACT_APP_API_URL}/${slideImage}` : '/img/property/solitary.jpg'}
										alt={'main-image'}
									/>
								</Stack>
								...
								<Stack className={'sub-images'}>
									{property?.propertyImages.map((subImg: string) => {
										const imagePath: string = `${NEXT_PUBLIC_REACT_APP_API_URL}/${subImg}`;
										return (
							...
							<Stack className={'left-config'}>
								<Stack className={'options-config'}>
									...
									<Stack className={'option'}>
										...
										<Stack className={'option-includes'}>
											<Typography className={'title'}>Pulication date</Typography>
										...
										<Stack className={'info-box'}>
											<Stack className={'left'}>
												...
												<Box component={'div'} className={'info'}>
													...
													<Typography className={'data'}>5.48 x 1.08 x 8.23 inches</Typography>
												</Box>
												<Box component={'div'} className={'info'}>
										...
										<img
											...
											src={
												property?.memberData?.memberImage
													? `${NEXT_PUBLIC_REACT_APP_API_URL}/${property?.memberData?.memberImage}`
